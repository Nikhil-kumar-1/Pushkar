  ...
  const service = [
    {
      ...
      description:
        "Minimally invasive removal of gallstones through small abdominal incisions using advanced laparoscopic techniques. This procedure offers reduced pain, minimal scarring, and faster recovery compared to traditional open surgery.",
      image: Laparoscopic,
      benefits: [
        "100% success rate",
    ...
    },
    {
      ...
      description:
        "Advanced repair of inguinal, umbilical, and ventral hernias using mesh reinforcement through tiny incisions. Our technique reduces recurrence rates to less than 1% with minimal postoperative discomfort.",
    ...
    },
    {
      ...
      description:
        "Emergency removal of inflamed appendix through keyhole surgery, preventing rupture and life-threatening complications. Our same-day discharge protocol gets you home faster.",
    ...
    },
    {
      ...
      description:
        "Uterus-preserving myomectomy for symptomatic fibroids causing heavy bleeding or infertility. Our bloodless surgical technique eliminates fibroids while protecting healthy tissue.",
    ...
    },
    {
      ...
      description:
        "Painless, bloodless hemorrhoid treatment using advanced laser technology. Our 15-minute procedure eliminates piles permanently with zero hospital stay.",
      image: LaserPiles,
      benefits: [
        "No stitches or cuts",
    ...
    },
    {
      ...
      description:
        "Precision fistula closure using laser energy that seals the tract while preserving sphincter muscles. Our technique has 100% success rate with no incontinence risk.",
      image: LaserCyst,
      benefits: [
    ...
    },
    {
      ...
      description:
        "Pain relief and healing of chronic anal fissures with laser treatment that avoids muscle cutting. Our patients report immediate pain relief and complete healing in 7 days.",
      image: LaserPiles,
      benefits: [
        "No sphincter damage",
        "Bloodless procedure",
    ...
    },
    {
      ...
      description:
        "Minimally invasive laser treatment for pilonidal disease that eliminates sinus tracts permanently. Our technique has 95% success rate with no wound care needed.",
      image: LaserTumor,
      benefits: [
        "No open wound",
    ...
    },
    {
      ...
      description:
        "Bloodless, stitchless circumcision using laser technology for adults and children. Our painless technique takes just 20 minutes with immediate return to normal activities.",
    ...
    },
    {
      ...
      description:
        "Non-invasive removal of sebaceous, ganglion, and other cysts using laser ablation. Our scarless technique prevents recurrence while preserving surrounding tissue.",
      image: LaserCyst,
      benefits: [
        "No surgical scars",
        "5-minute procedure",
    ...
    },
    {
      ...
      description:
        "Precision removal of benign skin tumors like lipomas without incisions or stitches. Our laser excision leaves no visible marks with complete tumor clearance.",
      image: LaserTumor,
      benefits: [
        "No knife used",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://www.drpushkarsingh.com/services"
        />
        <meta
          property="og:image"
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center text-white">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Advanced{" "}
              <span className="text-[#6CCF5F]">Surgical Solutions</span>
            </h1>
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
              Minimally invasive laparoscopic and laser procedures for faster
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {service.map((service, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-[#1A1F1C] mb-3">
                    {service.title}
                  </h3>
                  <p className="text-gray-600 mb-4">{service.description}</p>

                  <div className="mb-4">
                    <h4 className="font-semibold text-[#6CCF5F] mb-2">
                      Key Benefits:
                    </h4>
                    <ul className="space-y-1 text-sm text-gray-600">
                      {service.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-start">
                          <svg
                            className="w-4 h-4 text-[#6CCF5F] mr-2 mt-0.5 flex-shrink-0"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
          ...
          >
            ...
            <p className="text-xl mb-6 max-w-3xl mx-auto">
              Schedule a consultation to discuss the best treatment options for
              your condition
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <motion.button
