      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            ...
            <div className="flex items-center space-x-4 pt-2">
              <motion.button
                ...
                className="cursor-pointer bg-[#25D366] p-2 rounded-full"
                aria-label="WhatsApp"
              >
                <svg
              ...
              <motion.button
                ...
                className="bg-[#6CCF5F] cursor-pointer p-3 rounded-full text-white shadow-lg"
                aria-label="Call"
              >
              ...
              <motion.button
                ...
                className="bg-gray-600 cursor-pointer p-2 rounded-full"
                aria-label="Email"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-bold text-[#6CCF5F]">Quick Links</h3>
            <ul className="space-y-2">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-bold text-[#6CCF5F]">Contact Info</h3>
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 text-[#6CCF5F] mt-1"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        >
          <p>
            &copy; {new Date().getFullYear()} Dr. Pushkar Anand Singh Clinic.
            All Rights Reserved.
          </p>
